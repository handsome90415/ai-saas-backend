...
class User(Base):
    ...
    openai_model: Mapped[str] = mapped_column(String, default="gpt-4o-mini")
    gemini_api_key: Mapped[str | None] = mapped_column(String, nullable=True)
    gemini_model: Mapped[str] = mapped_column(String, default="gemini-1.5-flash")
    claude_api_key: Mapped[str | None] = mapped_column(String, nullable=True)
    claude_model: Mapped[str] = mapped_column(String, default="claude-3-haiku-20240307")
